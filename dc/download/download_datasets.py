...
class DownloadDatasets:
    ...
    def download_iu_xray(self, split_rate=0.9):
        ...
        self.create_directory_for_dataset(dataset_name)
        ...
        for report in reports:
            ...
            self.write_dataset(dataset_name, images_captions, images_major_tags, images_auto_tags=images_auto_tags)
            self.split_dataset(reports_with_images,dataset_name, split_rate, text_of_reports)
    ...
    def download_peir_gross(self, split_rate=0.9):
        ...
        self.create_directory_for_dataset(dataset_name)
        image_captions, image_tags = self.download_dataset(dataset_name)
        self.write_dataset(dataset_name, image_captions, image_tags)
        self.split_dataset(image_captions, dataset_name, split_rate)

    def create_directory_for_dataset(self, dataset_folder_name):
    ...
    def write_dataset(self, dataset_folder_name, images_captions, images_tags, images_auto_tags=None):
    ...
    def split_dataset(self, data, dataset_name_folder, split_rate, text_of_reports=None):
        ...
        self.split_images(data, train_keys, train_path, text_of_reports=text_of_reports)
        self.split_images(data, test_keys, test_path, text_of_reports=text_of_reports)
    ...
    def download_dataset(self, dataset):
        if dataset is 'iu_xray':
            ...
            return self.crawl_peir_gross()

    def crawl_peir_gross(self):
